...
// ➕ เพิ่ม import normalizeKey และ formatTime
...
export default function AnalysisPage() {
  ...
  // 🔄 แทนการใช้ stats.useMemo เดิม: สร้างกลุ่มคำตอบตาม normalized key
    ...
    <ThemedLayout>
      <div className="p-6 max-w-4xl mx-auto space-y-6">
        ...
        {loading ? (
          ...
          <>
            {/* ➕ ส่วนสรุป insight: ใช้ formatTime สำหรับเวลาที่อ่านง่าย */}
